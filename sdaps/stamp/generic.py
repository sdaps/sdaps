...
def create_stamp_pdf(survey, output_filename, questionnaire_ids):
    ...
    if have_pdftk:
        ...
        if sheets == 1:
            ...
            print _(u"PDFtk: Splitting the questionnaire for marking.")
            ...
            if sheets == 1:
                for page in xrange(1, questionnaire_length + 1):
                    print ungettext(u"PDFtk: Marking page %d of all stacks.", u"PDFtk: Marking page %d of all stacks.", page) % page
                    subprocess.call(['pdftk',
        ...
        print _(u'Marking using pyPdf. For faster marking, install PDFtk.')
        log.progressbar.start(sheets)
